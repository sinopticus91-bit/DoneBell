(() => {
  ...
  const ALERT_FIELDS=['soundEnabled','soundVolume','repeatSound','silentWhenActive','focusTab','stopOnTabFocus','stopOnAutoFocus','showNotification','flashTitle','inPagePanel'];
  const PROFILES={
    quiet:{soundEnabled:false,repeatSound:false,silentWhenActive:false,focusTab:false,stopOnTabFocus:false,stopOnAutoFocus:false,showNotification:true,flashTitle:true,inPagePanel:false},
    normal:{soundEnabled:true,repeatSound:false,silentWhenActive:false,focusTab:false,stopOnTabFocus:false,stopOnAutoFocus:false,showNotification:true,flashTitle:true,inPagePanel:true},
    urgent:{soundEnabled:true,repeatSound:true,silentWhenActive:false,focusTab:true,stopOnTabFocus:false,stopOnAutoFocus:false,showNotification:true,flashTitle:true,inPagePanel:true}
  };
